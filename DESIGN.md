...
시간, 정류장 점, 연결선, 장소 내용을 하나의 행 구조로 묶습니다. 완료한 정류장은 Success Green과 체크 아이콘으로 표시하고, 다음 정류장은 Destination Green으로 강조합니다. 완료 여부는 색과 취소선에만 기대지 않고 화면 읽기 프로그램이 읽을 수 있는 글자를 함께 둡니다.
