...
Direction: The Pocket Atlas. 웜 페이퍼 지도 종이, 딥 잉크, 더스크 인디고 경로, 올리브 그린 목적지 표식. 날짜는 노선, 일정과 장소는 정류장으로 표현한다.

Memorable moment: 시작 화면의 세 정류장과 여행 화면의 다음 정류장이 같은 시각 언어로 이어지고, 올리브 그린 길찾기 버튼이 목적지 행동을 명확히 마무리한다.
