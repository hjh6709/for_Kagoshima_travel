...
export function ManageAccountPage(props: TripManagePageProps) {
  const { auth, authChecked, onAuthChanged, onLogout } = props;
    ...
    <main className="app-shell">
      <section className="phone-frame owner-frame">
        <div className="content">
          <section
            className={`screen owner-screen${authChecked && auth ? " mypage-screen" : ""}`}
          >
            ...
            {authChecked && auth && (
              <>
                <a
                  className="back-to-list-link account-back-link"
                  href="/manage"
                >
